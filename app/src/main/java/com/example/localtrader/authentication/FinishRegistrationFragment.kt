 ...
 * Use the [FinishRegistrationFragment.newInstance] factory method to
...
class FinishRegistrationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FinishRegistrationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FinishRegistrationFragment().apply {
